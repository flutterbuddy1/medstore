						...
						<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
							<a class="dropdown-item" href="add_purchase.php">
								<label class="btn btn-sm btn-primary btn-simple active" id="0">
									<span class="d-none d-sm-block d-md-block d-lg-block d-xl-block">Add new Entry</span>
									<span class="d-block d-sm-none">
										<i class="tim-icons icon-single-02"></i>
									</span>
								</label>
							</a>
							<a class="dropdown-item" href="delete_entry.php">
								<label class="btn btn-sm btn-primary btn-simple active" id="0">
									<span class="d-none d-sm-block d-md-block d-lg-block d-xl-block" name="delete">Delete Entry</span>
									<span class="d-block d-sm-none">
										<i class="tim-icons icon-single-02"></i>
									</span>
								</label>
							...
							<tbody>
								<tr>
									...
									<td>
										...
										<p class="text-muted"><?php echo $data['purchase_description'];?></p>
									</td>
